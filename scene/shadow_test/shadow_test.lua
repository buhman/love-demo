...
ns.array_node_point001_translation_x_input_array = {
  0.0,
  0.2333333,
  0.4333333,
  0.6333333,
...
ns.array_node_point001_translation_x_output_array = {
  -42.21109,
  -42.21108,
  64.55054,
  77.47449,
...
ns.array_node_point001_translation_x_intangent_array = {
  -0.3329306, -42.21109,
  0.1556333, -42.21109,
  0.3667333, 51.6395,
  0.5667334, 77.47449,
...
ns.array_node_point001_translation_x_outtangent_array = {
  0.0777, -42.21109,
  0.2999333, -42.21107,
  0.4999333, 77.46157,
  0.6999334, 77.47449,
...
ns.array_node_point001_translation_x_interpolation_array = {
...
ns.sampler_node_point001_translation_x_sampler = {
  -- node_point001_translation_x_input
  input = {
    float_array = ns.array_node_point001_translation_x_input_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_x_output
  output = {
    float_array = ns.array_node_point001_translation_x_output_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_x_intangent
  in_tangent = {
    float_array = ns.array_node_point001_translation_x_intangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_x_outtangent
  out_tangent = {
    float_array = ns.array_node_point001_translation_x_outtangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_x_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point001_translation_x_interpolation_array,
    count = 17,
    stride = 1,
  },
}
ns.array_node_point001_translation_y_input_array = {
  0.0,
  0.2333333,
  0.4333333,
  0.6333333,
...
ns.array_node_point001_translation_y_intangent_array = {
  -0.3329306, -40.46347,
  0.1556333, 92.09061,
  0.3667333, 92.09061,
  0.5667334, -70.41342,
...
ns.array_node_point001_translation_y_outtangent_array = {
  0.0777, -40.46347,
  0.2999333, 92.09061,
  0.4999333, 92.09061,
  0.6999334, -70.41342,
...
ns.array_node_point001_translation_y_interpolation_array = {
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
...
ns.sampler_node_point001_translation_y_sampler = {
  -- node_point001_translation_y_input
  input = {
    float_array = ns.array_node_point001_translation_y_input_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_y_output
  output = {
    float_array = ns.array_node_point001_translation_y_output_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_y_intangent
  in_tangent = {
    float_array = ns.array_node_point001_translation_y_intangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_y_outtangent
  out_tangent = {
    float_array = ns.array_node_point001_translation_y_outtangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_y_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point001_translation_y_interpolation_array,
    count = 17,
    stride = 1,
  },
}
ns.array_node_point001_translation_z_input_array = {
  0.0,
  0.2333333,
  0.4333333,
  0.6333333,
...
ns.array_node_point001_translation_z_output_array = {
  156.481,
  156.481,
  156.481,
  156.481,
...
ns.array_node_point001_translation_z_intangent_array = {
  -0.3329306, 156.481,
  0.1556333, 156.481,
  0.3667333, 156.481,
  0.5667334, 156.481,
...
ns.array_node_point001_translation_z_outtangent_array = {
  0.0777, 156.481,
  0.2999333, 156.481,
  0.4999333, 156.481,
  0.6999334, 156.481,
...
ns.array_node_point001_translation_z_interpolation_array = {
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
...
ns.sampler_node_point001_translation_z_sampler = {
  -- node_point001_translation_z_input
  input = {
    float_array = ns.array_node_point001_translation_z_input_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_z_output
  output = {
    float_array = ns.array_node_point001_translation_z_output_array,
    count = 17,
    stride = 1,
  },
  -- node_point001_translation_z_intangent
  in_tangent = {
    float_array = ns.array_node_point001_translation_z_intangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_z_outtangent
  out_tangent = {
    float_array = ns.array_node_point001_translation_z_outtangent_array,
    count = 17,
    stride = 2,
  },
  -- node_point001_translation_z_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point001_translation_z_interpolation_array,
    count = 17,
    stride = 1,
  },
}
ns.array_node_direct001_matrix_input_array = {
  0.0,
  0.03333333,
  0.06666667,
  0.1,
...
ns.array_node_direct001_matrix_interpolation_array = {
...
ns.sampler_node_direct001_matrix_sampler = {
  -- node_direct001_matrix_input
  input = {
    float_array = ns.array_node_direct001_matrix_input_array,
    count = 101,
    stride = 1,
  },
  -- node_direct001_matrix_output
  output = {
    float_array = ns.array_node_direct001_matrix_output_array,
    count = 101,
    stride = 16,
  },
  -- node_direct001_matrix_interpolation
  interpolation = {
    interpolation_array = ns.array_node_direct001_matrix_interpolation_array,
    count = 101,
    stride = 1,
  },
}
ns.array_node_point002_translation_x_input_array = {
  0.0,
  0.8333334,
  1.666667,
  2.5,
...
ns.array_node_point002_translation_x_output_array = {
  -57.36452,
  -158.3051,
  6.142715,
  214.8339,
...
ns.array_node_point002_translation_x_intangent_array = {
  -0.3329306, -57.36452,
  0.5558333, -158.3051,
  1.389167, -55.98494,
  2.2225, 214.8339,
...
ns.array_node_point002_translation_x_outtangent_array = {
  0.2775, -57.36452,
  1.110833, -158.3051,
  1.944167, 68.27037,
  2.7775, 214.8339,
...
ns.array_node_point002_translation_x_interpolation_array = {
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
...
ns.sampler_node_point002_translation_x_sampler = {
  -- node_point002_translation_x_input
  input = {
    float_array = ns.array_node_point002_translation_x_input_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_x_output
  output = {
    float_array = ns.array_node_point002_translation_x_output_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_x_intangent
  in_tangent = {
    float_array = ns.array_node_point002_translation_x_intangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_x_outtangent
  out_tangent = {
    float_array = ns.array_node_point002_translation_x_outtangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_x_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point002_translation_x_interpolation_array,
    count = 5,
    stride = 1,
  },
}
ns.array_node_point002_translation_y_input_array = {
  0.0,
  0.8333334,
  1.666667,
  2.5,
...
ns.array_node_point002_translation_y_output_array = {
  159.98,
  -1.736969,
  -219.6883,
  -4.115463,
...
ns.array_node_point002_translation_y_intangent_array = {
  -0.3329306, 159.98,
  0.5558333, 61.4778,
  1.389167, -219.6883,
  2.2225, -67.33023,
...
ns.array_node_point002_translation_y_outtangent_array = {
  0.2775, 159.98,
  1.110833, -64.95174,
  1.944167, -219.6883,
  2.7775, 59.0993,
...
ns.array_node_point002_translation_y_interpolation_array = {
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
...
ns.sampler_node_point002_translation_y_sampler = {
  -- node_point002_translation_y_input
  input = {
    float_array = ns.array_node_point002_translation_y_input_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_y_output
  output = {
    float_array = ns.array_node_point002_translation_y_output_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_y_intangent
  in_tangent = {
    float_array = ns.array_node_point002_translation_y_intangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_y_outtangent
  out_tangent = {
    float_array = ns.array_node_point002_translation_y_outtangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_y_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point002_translation_y_interpolation_array,
    count = 5,
    stride = 1,
  },
}
ns.array_node_point002_translation_z_input_array = {
  0.0,
  0.8333334,
  1.666667,
  2.5,
...
ns.array_node_point002_translation_z_output_array = {
  269.2574,
  269.2574,
  269.2574,
  269.2574,
...
ns.array_node_point002_translation_z_intangent_array = {
  -0.3329306, 269.2574,
  0.5558333, 269.2574,
  1.389167, 269.2574,
  2.2225, 269.2574,
...
ns.array_node_point002_translation_z_outtangent_array = {
  0.2775, 269.2574,
  1.110833, 269.2574,
  1.944167, 269.2574,
  2.7775, 269.2574,
...
ns.array_node_point002_translation_z_interpolation_array = {
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
  collada_types.interpolation.BEZIER,
...
ns.sampler_node_point002_translation_z_sampler = {
  -- node_point002_translation_z_input
  input = {
    float_array = ns.array_node_point002_translation_z_input_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_z_output
  output = {
    float_array = ns.array_node_point002_translation_z_output_array,
    count = 5,
    stride = 1,
  },
  -- node_point002_translation_z_intangent
  in_tangent = {
    float_array = ns.array_node_point002_translation_z_intangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_z_outtangent
  out_tangent = {
    float_array = ns.array_node_point002_translation_z_outtangent_array,
    count = 5,
    stride = 2,
  },
  -- node_point002_translation_z_interpolation
  interpolation = {
    interpolation_array = ns.array_node_point002_translation_z_interpolation_array,
    count = 5,
    stride = 1,
  },
}
ns.array_node_camera001_matrix_input_array = {
  0.0,
  0.03333333,
  0.06666667,
  0.1,
...
ns.array_node_camera001_matrix_output_array = {
...
ns.array_node_camera001_matrix_interpolation_array = {
  collada_types.interpolation.LINEAR,
  collada_types.interpolation.LINEAR,
  collada_types.interpolation.LINEAR,
  collada_types.interpolation.LINEAR,
...
ns.sampler_node_camera001_matrix_sampler = {
  -- node_camera001_matrix_input
  input = {
    float_array = ns.array_node_camera001_matrix_input_array,
    count = 101,
    stride = 1,
  },
  -- node_camera001_matrix_output
  output = {
    float_array = ns.array_node_camera001_matrix_output_array,
    count = 101,
    stride = 16,
  },
  -- node_camera001_matrix_interpolation
  interpolation = {
    interpolation_array = ns.array_node_camera001_matrix_interpolation_array,
    count = 101,
    stride = 1,
  },
}
ns.node_channel_node_point001_translation_x = {
  source_sampler = ns.sampler_node_point001_translation_x_sampler,
  target_transform_index = 0,
  target_attribute = collada_types.target_attribute.X,
}
ns.node_channel_node_point001_translation_y = {
  source_sampler = ns.sampler_node_point001_translation_y_sampler,
  target_transform_index = 0,
...
ns.node_channel_node_point002_translation_x = {
  source_sampler = ns.sampler_node_point002_translation_x_sampler,
  target_transform_index = 0,
  target_attribute = collada_types.target_attribute.X,
}
ns.node_channel_node_point002_translation_y = {
  source_sampler = ns.sampler_node_point002_translation_y_sampler,
  target_transform_index = 0,
  target_attribute = collada_types.target_attribute.Y,
}
ns.node_channel_node_point002_translation_z = {
...
ns.transforms_node_point001 = {
  {
    type = collada_types.transform_type.TRANSLATE,
    translate = {-42.21109, -40.46347, 156.481},
  },
}
...
ns.transforms_node_direct001 = {
  {
    ...
    matrix = {0.692005, -0.7218927, 0.0, 0.0, 0.6737756, 0.64588, 0.3589784, 0.0, -0.2591439, -0.2484148, 0.9333459, 0.0, -4.146301, -3.974632, 10.48219, 1.0},
  },
}
...
ns.transforms_node_point002 = {
  {
    type = collada_types.transform_type.TRANSLATE,
    translate = {-57.36452, 159.98, 269.2574},
  },
}
ns.instance_geometries_node_point002 = {
}
ns.instance_controllers_node_point002 = {
}
ns.instance_lights_node_point002 = {
}
ns.node_channels_node_point002 = {
  ns.node_channel_node_point002_translation_z,
  ns.node_channel_node_point002_translation_y,
  ns.node_channel_node_point002_translation_x,
}
ns.node_node_point002 = {
  node_name = "node_point002",

  parent_index = -1,

  type = collada_types.node_type.NODE,

  transforms = ns.transforms_node_point002,
  transforms_count = 1,

  instance_geometries = ns.instance_geometries_node_point002,
  instance_geometries_count = 0,

  instance_controllers = ns.instance_controllers_node_point002,
  instance_controllers_count = 0,

  instance_lights = ns.instance_lights_node_point002,
  instance_lights_count = 0,

  channels = ns.node_channels_node_point002,
  channels_count = 3,
}
ns.transforms_node_camera001 = {
  {
    type = collada_types.transform_type.MATRIX,
    matrix = {-0.9161802, -0.4006261, -0.01059775, 0.0, 0.3124457, -0.7305838, 0.6071451, 0.0, -0.2509807, 0.5529431, 0.7945203, 0.0, -3.604237, 4.948456, 0.0, 1.0},
  },
}
...
ns.nodes = {
  ...
  ns.node_node_torus_knot001, -- 3
  ns.node_node_direct001_target, -- 4
  ns.node_node_cone001, -- 5
  ns.node_node_box001, -- 6
  ns.node_node_point001, -- 7
  ns.node_node_direct001, -- 8
  ns.node_node_point002, -- 9
